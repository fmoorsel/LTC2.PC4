...
namespace LTC2.Webapps.MainApp.Controllers
{
    ...
    public class HomeRideWithGpsController : Controller
    {
        ...
        public IActionResult CallbackConnect(string code, string state, string language = "nl")
        {
            ...
            _logger.LogInformation("Ride With GPS OAuth callback: code received, token exchange not yet implemented");

            return View("CallbackConnect");
        }
